...
public class Java_52_Thread_Priorities {
    public static void main(String[] args) {
        // Ready Queue: T1 T2 T3 T4 T5
        MyThr1 t1 = new MyThr1("Test1");
        MyThr1 t2 = new MyThr1("Test2");
        MyThr1 t3 = new MyThr1("Test3");
        MyThr1 t4 = new MyThr1("Test4");
        MyThr1 t5 = new MyThr1("Test5 (most Important)");
